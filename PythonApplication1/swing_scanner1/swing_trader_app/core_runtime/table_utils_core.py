...
def show_table(df, label, prob_col="Rise Prob"):
    ...
    if prob_col == "Fall Prob":
    ...
    elif prob_col == "Stage 2 Rank Score":
        wanted = [
            "Rank", "Ticker", "Action", "Stage 2 Phase", "Swing Quality Gate", "Early Missing",
            "Price", "Pivot", "Pivot Dist%", "Stage 2 Entry", "Stage 2 Volume Gate", "S2 RVOL Pace",
            "S2 RVOL Source", "Stage 2 Market Gate", "Stage 2 Sector Gate", "Earnings Days", "Earnings Gate",
            "Entry Quality", "Quality Score", "Stage 2 Rank Score", "Early Score", "Stage 2 Score",
            "Base Weeks", "Base Range%", "Contraction", "VDU Ratio", "RS Lead", "Sector Lead",
            "Post-Pivot Room", "Stage 2 Reward", "Stage 2 Risk%", "Stage 2 R:R", "Stage 2 Target",
            "Failed BO Exit", "Stage 2 Hard Stop", "S2 Shares/$1k", "S2 Time Stop",
        ...
        wanted = [
            ...
            "S2 Shares/$1k", "S2 Time Stop", "Stage 2 Buy Trigger", "Stage 2 Exit Plan",
            "Market Regime", "Stage 2 Market Gate", "Stage 2 Sector Gate", "Earnings Days",
            "Earnings Gate", "S2 RVOL Pace", "S2 RVOL Source", "Stage 2 Volume Gate",
            "RS Lead", "Sector Lead", "EPS Rev 60D", "EPS Revision Confirm", "Swing Quality Gate",
            "Swing Quality Why", "Early Missing", "Early Why", "Stage 2 Why",
    ...
    col_cfg = {
        ...
        "Stage 2 Stop": st.column_config.TextColumn("S2 Stop", width=70),
        "Stage 2 Risk%": st.column_config.TextColumn("S2 Risk", width=65),
        "Post-Pivot Room": st.column_config.TextColumn("Post-Pivot Room", width=100),
        "Stage 2 Reward": st.column_config.TextColumn("S2 Reward", width=75),
        "Stage 2 R:R": st.column_config.TextColumn("S2 R:R", width=60),
        "Stage 2 Entry": st.column_config.TextColumn("S2 Entry", width=75),
        "Stage 2 Target": st.column_config.TextColumn("S2 Target", width=75),
        "Failed BO Exit": st.column_config.TextColumn("Failed BO Exit", width=90),
        "Stage 2 Hard Stop": st.column_config.TextColumn("S2 Hard Stop", width=85),
        "S2 Shares/$1k": st.column_config.NumberColumn("Shares/$1k", width=80),
        "S2 Time Stop": st.column_config.TextColumn("Time Stop", width=70),
        "Stage 2 Buy Trigger": st.column_config.TextColumn("S2 Buy Trigger", width=260),
        "Stage 2 Exit Plan": st.column_config.TextColumn("S2 Exit Plan", width=320),
        "Market Regime": st.column_config.TextColumn("Market", width=70),
        "Stage 2 Market Gate": st.column_config.TextColumn("Mkt Gate", width=70),
        "Stage 2 Sector Gate": st.column_config.TextColumn("Sec Gate", width=70),
        "Earnings Days": st.column_config.TextColumn("Earn Days", width=75),
        "Earnings Gate": st.column_config.TextColumn("Earn Gate", width=75),
        "S2 RVOL Pace": st.column_config.TextColumn("RVOL Pace", width=75),
        "S2 RVOL Source": st.column_config.TextColumn("RVOL Source", width=120),
        "Stage 2 Volume Gate": st.column_config.TextColumn("Vol Gate", width=70),
        "Blue Sky": st.column_config.TextColumn("Blue Sky", width=65),
        ...
        "Swing Quality Gate": st.column_config.TextColumn("Swing Gate", width=80),
        "Swing Quality Why": st.column_config.TextColumn("Swing Quality", width=260),
